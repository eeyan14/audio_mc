...
[train_data,train_class,~] = get_set(words(1:2), names, 1, num_record, ...
                                    Fs, 'keyword', top_folder, audio_folder);
[test_data,test_class,~] = get_set(words(1:2), names, num_record+1, num_files, ...
                                    Fs, 'keyword', top_folder, audio_folder);
